  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className="card">
          <div
            className={`card-header cardheader ${stats.pickupCrates >= stats.totalCrates ? "requestmodal_highlight_cols" : ""}`}
          >
            <table>
              <tbody>
                <tr>
                  <td style={{ width: 27 }}>
                    ...
                    >
                      <img
                        className="card_req_manufacturerimage"
                        src="/img/glitch/IconFilterUtility.png"
                      />
                    </button>
                  </td>
                  <td
                  ...
                  <td className="card_crate_count_cell">
                    {stats.pickupCrates} / {stats.totalCrates}
                  </td>
                  <td style={{ width: 24 }}>
                    <Popover.default
...
class MyProductionCard extends React.Component {
  ...
  render() {
    ...
    if (this.props.request.length == 0) {
      ...
      //console.log(prodlines);
      const highlightCrates =
        stats.totalCrates > 0 && stats.totalCrates % 15 === 0;
      return (
        <div className="card">
          <Popover.default
            isOpen={this.state.isPopoverOpen}
          ...
          >
            ...
            >
              <img
                ...
                src="/img/glitch/gsds.jpg"
              />
            </button>
          </Popover.default>
          <div
            className={`card-header cardheader requestmodal_production_header ${highlightCrates ? "requestmodal_highlight_cols" : ""}`}
          >
            <span className="requestmodal_production_heading">
              Your production
            </span>
            <span className="requestmodal_production_amt">
              {stats.totalCrates}
            </span>
          </div>
  ...
  render() {
    ...
    return (
      <div className={"card other_production_card " + this.props.margin}>
        <div
          className={`card-header cardheader other_production_cardheader noclip ${highlightCrates ? "requestmodal_highlight_cols" : ""}`}
        >
