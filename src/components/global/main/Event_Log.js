    ...
    switch (obj.type) {
      ...
      case 1:
        ...
        let location = (
          <img
            style={{ width: 15, height: 15 }}
            src="/img/glitch/IconStatusEncumberedRed.png"
            onClick={() =>
      ...
      case 2:
        actionstring = (
          <span>
            <img
              style={{ width: 15, height: 15 }}
              src="/img/glitch/IconStatusEncumbered.png"
              onClick={() =>
      ...
      case 3:
          ...
          if (packet) {
            ...
            user = (
              <span>
                by{" "}
                <b>
                  {U.GetUsername(this.props.users.users, packet.request.author)}
                </b>
              </span>
            );
          }
        ...
        actionstring = (
          <span>
            New supply order requested {user}{" "}
            <img
              id="eventlog_logi_img"
              src="/img/glitch/IconStatusEncumberedRed.png"
              onClick={() => store.dispatch(A.selectObject("requests", key))}
            />
          </span>
        );
        break;
