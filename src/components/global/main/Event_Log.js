      ...
      switch(obj.type){
        ...
        case 1:
         ...
         // console.log("Private event packet",packet)
          ...
          let location = <img style={{width:15,height:15}} src='https://hq.mreboy.com/img/glitch/IconStatusEncumberedRed.png' onClick={()=>store.dispatch(A.selectObject("requests",packet.request))} />
         // console.log("wiparray",wiparray)
          actionstring = <span>{username} delivered {wiparray} to {location}</span>
          break;
        case 2:
          actionstring =<span><img style={{width:15,height:15}} src='https://hq.mreboy.com/img/glitch/IconStatusEncumbered.png' onClick={()=>store.dispatch(A.selectObject("requests",obj.packet))}/> completed</span>
          break;
        case 3:
          let key = obj.packet;
          let user;
          ...
          actionstring = <span>New supply order requested {user} <img id="eventlog_logi_img" src='https://hq.mreboy.com/img/glitch/IconStatusEncumberedRed.png' onClick={()=>store.dispatch(A.selectObject("requests",key))}/></span>
          break;
        case 4:
