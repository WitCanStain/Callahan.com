    ...
    <ul className="nav nav-tabs" role="tablist">
      ...
      >
        ...
        >
          <img
            className="nav_image"
            src="/img/glitch/MapIconHomeTownHallNeutral.png"
          />
        </a>
      </li>
      {
        ...
        >
          <a className="nav-link" data-toggle="tab" href="#home">
            <img
              className="nav_image"
              src="/img/glitch/IconFacilitiesRadioStation.png"
            />
          </a>
          {messagepill}
        </li>
      ...
      >
        <a className="nav-link" data-toggle="tab" href="#squadtab">
          <img
            className="nav_image"
            src="/img/glitch/IconFacilitiesLargeGarrison.png"
          />
        </a>
      </li>
      <li
      ...
      >
        ...
        >
          <img
            className="nav_image"
            src="/img/glitch/MapIconManufacturing.png"
          />
        </a>
      </li>
      <li
      ...
      >
        <a className="nav-link" data-toggle="tab" href="#logicalc">
          <img className="nav_image" src="/img/glitch/logi.png" />
        </a>
      </li>
      <li
        className="nav-item"
        id="techtreetab"
        onClick={() => store.dispatch(A.selectTab(4))}
      >
        <a
          className="nav-link"
          data-toggle="tab"
          ...
          onClick={() => store.dispatch(A.selectTab(4))}
        >
          <img className="nav_image" src="/img/glitch/flowcharticon.png" />
        </a>
      </li>
      ...
      {props.users.myrank < 3 && (
        ...
        >
          <a
            ...
            href="#manage"
          >
            <img className="nav_image" src="/img/glitch/6toothcog.png" />
          </a>
          {requestpill}
        </li>
      )}
    ...
    if (this.props.settings.optimer != undefined) {
      ...
      if (time == "00:01:00:00" && timerdate > now) {
        window.soundcontrol.PlaySingle(
          "/assets/audio/misc/OP.mp3?1559289539656",
        );
      }
    }
    return (
...
class TotalPlayers_ extends React.Component {
  ...
  render() {
    return (
      <p id="top_banner_playersonline">Online: {this.props.totalplayers}</p>
    );
  }
}
...
const mapStateToPropsUsers = (store) => {
  //Importing props from store
  //console.log(store)
  return {
    users: store.users,
