...
class ModalContainer extends React.Component {
  ...
  SubmitNoAuth() {
    if (this.state.name == "") {
      ...
      $.post(
        "/noauth?" + $.param({ name: this.state.name }),
        function (packet) {
          if (packet.redir) {
              ...
              <div className="modal-body">
                ...
                <div id="inf">
                  <h5>
                    <br />{" "}
                    <p id="crdt">
                      The Steam Authentication process will not gain access to
                      any private Steam data and will use public Steam
                      information and cookies to keep you logged in.
                    </p>
                  </h5>
                  <br />
                  ...
                  <h5>
                    <br />
                    Discuss foxhole Warden HQ with Kassandros at{" "}
                    <a href="https://discord.gg/82dk">
                      <img src="/img/glitch/disc.png?v=1560206167061" />
                      https://discord.gg/82dk
                    </a>
                    (subject to change)
                  </h5>
