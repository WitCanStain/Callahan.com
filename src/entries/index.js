...
class Room extends React.Component {
  ...
  render() {
    let roomlist = this.state.rooms.map((item) => (
      <RoomUnit key={item.globalid} item={item} />
    ));
    return <React.Fragment>{roomlist}</React.Fragment>;
  }
}
  ...
  return (
    <tr>
      <td className="removecell">
        ...
        >
          <img className="removeimage" src="/img/glitch/X.png" />
        </button>
      </td>
      <td>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                <h6>
                  Are you sure you want to leave room {this.state.roomname}?
                </h6>
                {this.state.admin ? (
...
class CreateModal extends React.Component {
  ...
  CreateRoom() {
    ...
    $.post(
      "/createroom?" + $.param({ id: steamid, settings: settings }),
      function (id) {
                    ...
                    <label className="form-check-label">
                      <h5>
                        ...
                        <img
                          ...
                          src="/img/glitch/logoColonial64.png"
                        />
                      </h5>
                    </label>
                  </div>
                  <div className="form-check-inline">
                    <label className="form-check-label">
                      <h5>
                        ...
                        <img
                          className="faction_img"
                          src="/img/glitch/logoWarden64.png"
                        />
                      </h5>
                    </label>
                  </div>
...
//Updates room status
socket.on("updateroom", function (roominfo) {
