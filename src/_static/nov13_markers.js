...
const MiscIconArray = [
  ...
  { name: ' HANS 100m', url: 'http://hq.mreboy.com/img/hans_100.png' }, // 35
];
...
function GenerateIcon(obj, param) {
  ...
  if (obj.flags & 0x10) {
    ...
    switch (obj.iconType) {
      case 11: case 17: case 19: case 27: case 28: case 29: case 33: case 34: case 35: case 36: case 45: case 46: case 47: case 51: case 52: case 53: case 56: case 57: case 58:
        if (param == 'min') {
