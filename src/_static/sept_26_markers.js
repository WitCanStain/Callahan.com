...
const MiscIconArray = [
...

  {
    ...
    url: `${repo2}Items/ListeningKitIcon.png`,
...
function GenerateIcon(obj, param) {
  ...
  if (obj.flags & 0x10) {
    ...
    switch (obj.iconType) {
      case 11: case 17: case 27: case 28: case 29: case 33: case 34: case 35: case 36: case 45: case 46: case 47: case 56: case 57: case 58:
        if (param == 'min') {
