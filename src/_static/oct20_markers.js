...
const MiscIconArray = [
  ...
  { name: ' Death Riders', url: 'http://hq.mreboy.com/img/82dk_deathriders.png' }, // 39
  { name: ' Logistics', url: 'http://hq.mreboy.com/img/82dk_logi.png' }, // 40
  { name: ' Medical', url: 'http://hq.mreboy.com/img/82dk_medical.png' }, // 41
  { name: ' Reductus', url: 'http://hq.mreboy.com/img/82dk_reductus.png' }, // 42
  { name: ' RIP', url: 'http://hq.mreboy.com/img/82dk_rip.png' }, // 43
  { name: ' Scarus', url: 'http://hq.mreboy.com/img/82dk_scarus.png' }, // 44
  { name: ' Tempestus', url: 'http://hq.mreboy.com/img/82dk_tempestus.png' }, // 45
